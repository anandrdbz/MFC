            ...
            do i = 1, 3
                do l = iz%beg, iz%end
                    do k = iy%beg, iy%end
                        do j = ix%beg, ix%end                       
                            jac_igr(j, k, l, i) = 0d0
                            jac_old_igr(j, k, l, i) = 0d0
                            jac_rhs_igr(j, k, l, i) = 0d0
                       end do
                    end do
                end do
            end do
                    ...
                    if(bcxb < -1) then
                        ...
                        do q = 1, 3
                            do l = 0, p
                                do k = 0, n
                                    do j = 1, buff_size
                                        jac_igr(-j,k,l, q) = jac_igr(0,k,l, q)
                                    end do
                                end do
                            end do
                        end do
                    ...
                    if(bcxe < -1) then
                        ...
                        do q = 1, 3
                            do l = 0, p
                                do k = 0, n
                                    do j = 1, buff_size
                                        jac_igr(m+j,k,l, q) = jac_igr(m,k,l, q)
                                    end do
                                end do
                            end do
                        end do
                    ...
                    if(bcyb < -1) then
                        ...
                        do q = 1, 3
                            do l = 0, p
                                do k = 1, buff_size
                                    do j = ix%beg, ix%end
                                        jac_igr(j,-k,l, q) = jac_igr(j,0,l, q)
                                    end do
                                end do
                            end do
                        end do
                    ...
                    if(bcye < -1) then
                        ...
                        do q = 1, 3
                            do l = 0, p
                                do k = 1, buff_size
                                    do j = ix%beg, ix%end
                                        jac_igr(j,n+k,l, q) = jac_igr(j,n,l, q)
                                    end do
                                end do
                            end do
                        end do
                    ...
                    if(bczb < -1) then
                        ...
                        do q = 1, 3
                            do l = 1, buff_size
                                do k = iy%beg, iy%end
                                    do j = ix%beg, ix%end
                                        jac_igr(j,k,-l, q) = jac_igr(j,k,0, q)
                                    end do
                                end do
                            end do
                        end do
                    ...
                    if(bcze < -1) then
                        ...
                        do q = 1, 3
                            do l = 1, buff_size
                                do k = iy%beg, iy%end
                                    do j = ix%beg, ix%end
                                        jac_igr(j,k,p+l, q) = jac_igr(j,k,p, q)
                                    end do
                                end do
                            end do
                        end do
