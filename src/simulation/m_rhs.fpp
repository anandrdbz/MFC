...
module m_rhs
 ...
 s_finalize_rhs_module
    ...
    real(kind(0d0)), allocatable, dimension(:, :) :: Op
...
!$acc update device(gamma_min, pres_inf)
        ...
        if (barotropic) then
            ...
            @:ALLOCATE(F_igr(1:9, ix%beg:ix%end, iy%beg:iy%end, iz%beg:iz%end), rhs_igr(1:9, ix%beg:ix%end, iy%beg:iy%end, iz%beg:iz%end)) 
            @:ALLOCATE(jac_igr(1:3, ix%beg:ix%end, iy%beg:iy%end, iz%beg:iz%end), jac_old_igr(1:3, ix%beg:ix%end, iy%beg:iy%end, iz%beg:iz%end), jac_rhs_igr(1:3, ix%beg:ix%end, iy%beg:iy%end, iz%beg:iz%end))
            ...
            do l = iz%beg, iz%end
                do k = iy%beg, iy%end
                    do j = ix%beg, ix%end
                       do i = 1, 3
                            jac_igr(i, j, k, l) = 0d0
                            jac_old_igr(i, j, k, l) = 0d0
                            jac_rhs_igr(i, j, k, l) = 0d0
                       end do
                    end do
                end do
            end do
...
!$acc parallel loop collapse(4) gang vector default(present)
    ...
    subroutine s_compute_rhs(q_cons_vf, q_prim_vf, rhs_vf, pb, rhs_pb, mv, rhs_mv, t_step, lw) ! -------
        ...
        real(kind(0d0)) :: s2, const_sos, s1, rho_lx, rho_rx, rho_ly, rho_ry, sum
...
!!$acc parallel loop collapse(3) gang vector default(present)
            ...
            if (id == 1) then
                ...
                do l = iz%beg + 1, iz%end - 1
                    do k = iy%beg + 1, iy%end - 1
                        do j = ix%beg + 1, ix%end - 1
                            rhs_igr(1, j, k, l) = rho_igr(j,k,l) *alf_igr  *2d0 * (dux_igr(j,k,l)*dux_igr(j,k,l) + dvx_igr(j,k,l) * duy_igr(j,k,l) + dwx_igr(j,k,l) * duz_igr(j,k,l))
                            rhs_igr(2, j, k, l) = rho_igr(j,k,l) *alf_igr  *2d0 * (duy_igr(j,k,l)*dux_igr(j,k,l) + dvy_igr(j,k,l) * duy_igr(j,k,l) + dwy_igr(j,k,l) * duz_igr(j,k,l))                        
                            rhs_igr(3, j, k, l) = rho_igr(j,k,l) *alf_igr  *2d0 * (duz_igr(j,k,l)*dux_igr(j,k,l) + dvz_igr(j,k,l) * duy_igr(j,k,l) + dwz_igr(j,k,l) * duz_igr(j,k,l))

                            rhs_igr(4, j, k, l) = rho_igr(j,k,l) *alf_igr  *2d0 * (dux_igr(j,k,l)*dvx_igr(j,k,l) + dvx_igr(j,k,l) * dvy_igr(j,k,l) + dwx_igr(j,k,l) * dvz_igr(j,k,l))
                            rhs_igr(5, j, k, l) = rho_igr(j,k,l) *alf_igr  *2d0 * (duy_igr(j,k,l)*dvx_igr(j,k,l) + dvy_igr(j,k,l) * dvy_igr(j,k,l) + dwy_igr(j,k,l) * dvz_igr(j,k,l))                        
                            rhs_igr(6, j, k, l) = rho_igr(j,k,l) *alf_igr  *2d0 * (duz_igr(j,k,l)*dvx_igr(j,k,l) + dvz_igr(j,k,l) * dvy_igr(j,k,l) + dwz_igr(j,k,l) * dvz_igr(j,k,l))

                            rhs_igr(7, j, k, l) = rho_igr(j,k,l) *alf_igr  *2d0 * (dux_igr(j,k,l)*dwx_igr(j,k,l) + dvx_igr(j,k,l) * dwy_igr(j,k,l) + dwx_igr(j,k,l) * dwz_igr(j,k,l))
                            rhs_igr(8, j, k, l) = rho_igr(j,k,l) *alf_igr  *2d0 * (duy_igr(j,k,l)*dwx_igr(j,k,l) + dvy_igr(j,k,l) * dwy_igr(j,k,l) + dwy_igr(j,k,l) * dwz_igr(j,k,l))                        
                            rhs_igr(9, j, k, l) = rho_igr(j,k,l) *alf_igr  *2d0 * (duz_igr(j,k,l)*dwx_igr(j,k,l) + dvz_igr(j,k,l) * dwy_igr(j,k,l) + dwz_igr(j,k,l) * dwz_igr(j,k,l))
                ...
                do l = iz%beg + 2, iz%end - 1
                    do k = iy%beg + 2, iy%end - 1
                        do j = ix%beg + 2, ix%end - 1
                            ...
                            jac_rhs_igr(1, j, k, l) = (1d0 / dx(j))*(rhs_igr(1,j-1,k,l) - rhs_igr(1,j,k,l))  + (1d0 / dy(k))*(rhs_igr(2,j,k-1,l) - rhs_igr(2,j,k,l)) + (1d0 / dz(l))*(rhs_igr(3,j,k,l-1) - rhs_igr(3,j,k,l)) 
                            jac_rhs_igr(2, j, k, l) = (1d0 / dx(j))*(rhs_igr(4,j-1,k,l) - rhs_igr(4,j,k,l))  + (1d0 / dy(k))*(rhs_igr(5,j,k-1,l) - rhs_igr(5,j,k,l)) + (1d0 / dz(l))*(rhs_igr(6,j,k,l-1) - rhs_igr(6,j,k,l))
                            jac_rhs_igr(3, j, k, l) = (1d0 / dx(j))*(rhs_igr(7,j-1,k,l) - rhs_igr(7,j,k,l))  + (1d0 / dy(k))*(rhs_igr(8,j,k-1,l) - rhs_igr(8,j,k,l)) + (1d0 / dz(l))*(rhs_igr(9,j,k,l-1) - rhs_igr(9,j,k,l))
                       end do
                    end do
                end do
                ...
                do l = 0, p
                    do k = 0, n
                        do j = 0, m
                            ...
                            rho_lz = rho_igr(j,k,l-1)

                            rho_rx = rho_igr(j,k,l)
                            rho_ry = rho_igr(j,k,l)
                            rho_rz = rho_igr(j,k,l)

                            fd_coeff(j,k,l) = rho_igr(j,k,l) / alf_igr

                            if(bcxb < -1 .and. j == 0) then
                                rho_lx = 0d0
                            end if

                            if(bcxe < -1 .and. j == m) then
                                rho_rx = 0d0
                            end if

                            if(bcyb < -1 .and. k == 0) then
                                rho_ly = 0d0
                            end if

                            if(bcye < -1 .and. k == n) then
                                rho_ry = 0d0
                            end if

                            if(bczb < -1 .and. l == p) then
                                rho_lz = 0d0
                            end if

                            if(bcze < -1 .and. l == p) then
                                rho_rz = 0d0
                            end if
                ...
                do i = 1, 10
                        ...
                        do l = 0, p
                            do k = 0, n
                                do j = 0, m
                                    ...
                                    jac_igr(q, j, k, l) = jac_rhs_igr(q, j, k, l)
                                    ...
                                    jac_igr(q,j,k,l) = jac_igr(q,j,k,l)+ (1d0 / dx(j)**2d0) * (rho_lx* jac_old_igr(q,j-1,k,l) + rho_rx*jac_old_igr(q,j+1,k,l)) &
                                            + (1d0 / dy(k)**2d0) * (rho_ly* jac_old_igr(q,j,k-1,l) + rho_ry* jac_old_igr(q,j,k+1,l)) + (1 / dz(l)**2d0)*(rho_lz* jac_old_igr(q,j,k,l-1) + rho_rz* jac_old_igr(q,j,k,l+1))

                                    jac_igr(q, j, k, l) = omega * (1 / fd_coeff(j,k,l))*jac_igr(q,j,k,l) + (1 - omega)*jac_old_igr(q, j, k, l)
                        ...
                        if(bcxb >= 0) then
                            ...
                            do q = 1, 3
                                do l = 0, p
                                    do k = 0, n
                                        do j = 1, buff_size
                                            jac_igr(q,-j, k, l) = jac_igr(q,m-j+1,k,l)
                                        end do
                                    end do
                                end do
                            end do
                        ...
                        if(bcxe >= 0) then
                            ...
                            do q = 1, 3
                                do l = 0, p
                                    do k = 0, n
                                        do j = 1, buff_size
                                            jac_igr(q,m+j, k, l) = jac_igr(q,j-1,k,l)
                                        end do
                                    end do
                                end do
                            end do
                        ...
                        if(bcyb >= 0) then
                            ...
                            do q = 1, 3
                                do l = 0, p
                                    do k = 1, buff_size
                                        do j = ix%beg, ix%end
                                            jac_igr(q,j,-k,l) = jac_igr(q,j,n-k+1,l)
                                        end do
                                    end do
                                end do
                            end do
                        ...
                        if(bcye >= 0) then
                            ...
                            do q = 1, 3
                                do l = 0, p
                                    do k = 1, buff_size
                                        do j = ix%beg, ix%end
                                            jac_igr(q,j,n+k,l) = jac_igr(q,j,k-1,l)
                                        end do
                                    end do
                                end do
                            end do
                        ...
                        if(bczb >= 0) then
                            ...
                            do q = 1, 3
                                do l = 1, buff_size
                                    do k = iy%beg, iy%end
                                        do j = ix%beg, ix%end
                                            jac_igr(q,j,k,-l) = jac_igr(q,j,k,p-l+1)
                                        end do
                                    end do
                                end do
                            end do
                        ...
                        if(bcze >= 0) then
                            ...
                            do q = 1, 3
                                do l = 1, buff_size
                                    do k = iy%beg, iy%end
                                        do j = ix%beg, ix%end
                                            jac_igr(q,j,k,p+l) = jac_igr(q,j,k,l-1)
                                        end do
                                    end do
                                end do
                            end do
                    ...
                    do q = 1, 3
                        do l = iz%beg, iz%end
                            do k = iy%beg, iy%end
                                do j = ix%beg, ix%end
                                    jac_old_igr(q, j, k, l) = jac_igr(q, j, k, l)
                                end do
                            end do 
                        end do
                    end do
                    ...
                    !print *, "NAN", proc_rank, fd_coeff(0:buff_size-1, 199), fd_coeff(m:m+buff_size, 199)
                    !print *, "NAN", proc_rank, rhs_igr(3, m-buff_size+1:m, 98), rhs_igr(4, m-buff_size+1:m, 98)
                ...
                if(bcxb < -1) then
                    ...
                    do q = 1, 3
                        do l = 0, p
                            do k = 0, n
                                do j = 1, buff_size
                                    jac_igr(q,-j,k,l) = jac_igr(q,0,k,l)
                                end do
                            end do
                        end do
                    end do
                ...
                if(bcxe < -1) then
                    ...
                    do q = 1, 3
                        do l = 0, p
                            do k = 0, n
                                do j = 1, buff_size
                                    jac_igr(q,m+j,k,l) = jac_igr(q,m,k,l)
                                end do
                            end do
                        end do
                    end do
                ...
                if(bcyb < -1) then
                    ...
                    do q = 1, 3
                        do l = 0, p
                            do k = 1, buff_size
                                do j = ix%beg, ix%end
                                    jac_igr(q,j,-k,l) = jac_igr(q,j,0,l)
                                end do
                            end do
                        end do
                    end do
                ...
                if(bcye < -1) then
                    ...
                    do q = 1, 3
                        do l = 0, p
                            do k = 1, buff_size
                                do j = ix%beg, ix%end
                                    jac_igr(q,j,n+k,l) = jac_igr(q,j,n,l)
                                end do
                            end do
                        end do
                    end do
                ...
                if(bczb < -1) then
                    ...
                    do q = 1, 3
                        do l = 1, buff_size
                            do k = iy%beg, iy%end
                                do j = ix%beg, ix%end
                                    jac_igr(q,j,k,-l) = jac_igr(q,j,k,0)
                                end do
                            end do
                        end do
                    end do
                ...
                if(bcze < -1) then
                    ...
                    do q = 1, 3
                        do l = 1, buff_size
                            do k = iy%beg, iy%end
                                do j = ix%beg, ix%end
                                    jac_igr(q,j,k,p+l) = jac_igr(q,j,k,p)
                                end do
                            end do
                        end do
                    end do
                ...
                do l = iz%beg, iz%end - 1
                    do k = iy%beg , iy%end - 1
                        do j = ix%beg , ix%end - 1                        
                            F_igr(1, j, k) = 1d0* (rhs_igr(1, j, k) - rho_igr(j,k,l)*(1d0 / dx(j))*(jac_igr(1,j+1,k,l) - jac_igr(1,j,k,l)))
                            F_igr(2, j, k) = 1d0* (rhs_igr(2, j, k) - rho_igr(j,k,l)*(1d0 / dy(k))*(jac_igr(1,j,k+1,l) - jac_igr(1,j,k,l)))
                            F_igr(3, j, k) = 1d0* (rhs_igr(3, j, k) - rho_igr(j,k,l)*(1d0 / dz(l))*(jac_igr(1,j,k,l+1) - jac_igr(1,j,k,l)))

                            F_igr(4, j, k) = 1d0* (rhs_igr(4, j, k) - rho_igr(j,k,l)*(1d0 / dx(j))*(jac_igr(2,j+1,k,l) - jac_igr(2,j,k,l)))
                            F_igr(5, j, k) = 1d0* (rhs_igr(5, j, k) - rho_igr(j,k,l)*(1d0 / dy(k))*(jac_igr(2,j,k+1,l) - jac_igr(2,j,k,l)))
                            F_igr(6, j, k) = 1d0* (rhs_igr(6, j, k) - rho_igr(j,k,l)*(1d0 / dz(l))*(jac_igr(2,j,k,l+1) - jac_igr(2,j,k,l)))                            

                            F_igr(7, j, k) = 1d0* (rhs_igr(7, j, k) - rho_igr(j,k,l)*(1d0 / dx(j))*(jac_igr(3,j+1,k,l) - jac_igr(3,j,k,l)))
                            F_igr(8, j, k) = 1d0* (rhs_igr(8, j, k) - rho_igr(j,k,l)*(1d0 / dy(k))*(jac_igr(3,j,k+1,l) - jac_igr(3,j,k,l)))
                            F_igr(9, j, k) = 1d0* (rhs_igr(9, j, k) - rho_igr(j,k,l)*(1d0 / dz(l))*(jac_igr(3,j,k,l+1) - jac_igr(3,j,k,l)))
...
!!$acc parallel loop collapse(3) gang vector default(present)
            ...
            elseif (id == 2) then
                ...
                do k = -1, n+1
                    do j = 0, m
                        ...
                        flux_n(id)%vf(2)%sf(j,k,0) = &
                            ...
                            (q_prim_qp%vf(momxb + 1)%sf(j,k,0)*q_prim_qp%vf(momxb)%sf(j,k,0)) + &
                            F_igr(2, j, k)

                        flux_n(id)%vf(3)%sf(j, k, 0) = q_prim_qp%vf(contxb)%sf(j,k,0) * &
                            (q_prim_qp%vf(momxb + 1)%sf(j,k,0)**2d0) + &
                            q_prim_qp%vf(e_idx)%sf(j,k,0) + &
                            F_igr(4, j, k)
                    end do
                end do
                ...
                ! print *, "RHO",  q_prim_qp%vf(1)%sf(j, k, 0) 
                ! print *, "PRES", q_prim_qp%vf(4)%sf(j, k, 0)
                ! print *, "RHS IGR", rhs_igr(1:4, j, k) 
                ! print *, "JAC RHS SOL", jac_rhs_igr(2, j, k) , jac_igr(2, j, k)
                ! print *, "F_IGR", F_igr(4, j, k)
                
                ! print *, "RHS ACTUAL", rhs_vf(3)%sf(j, k, 0)
                ! print *, "FLUX ACTUAL", (1 / (2*dy(1)))* (flux_n(id)%vf(3)%sf(j, k-1, 0) - flux_n(id)%vf(3)%sf(j, k + 1, 0))
                ! print *, "FLUX_IGR_Y",  (1 / (2*dy(1)))* (F_igr(4, j, k-1) - F_igr(4, j, k + 1)) 

                ! k = 111
                ! print *, "PREV VEL",  q_prim_qp%vf(3)%sf(j, k, 0) 
                ! print *, "PREV RHO",  q_prim_qp%vf(1)%sf(j, k, 0) 
                ! print *, "PREV F", F_igr(4, j, k)
                ! print *, "PREV PRES", q_prim_qp%vf(4)%sf(j, k, 0)
                ! print *, "PREV JAC", jac_igr(2, j, k + 1), jac_igr(2, j, k) 
                ! print *, "PREV JAC RHS", jac_rhs_igr(2, j, k+1) , jac_rhs_igr(2, j, k)
                ! print *, "PREV RHS", rhs_igr(4, j, k), rhs_igr(4, j, k-1), rhs_igr(4, j, k+1)
                ! print *, "PREV DVDY", dvy_igr(j, k), dvy_igr(4, j, k-1) , dvy_igr(4, j, k+1)

                ! k = 113
                ! print *, "NEXT VEL",  q_prim_qp%vf(3)%sf(j, k, 0) 
                ! print *, "NEXT RHO",  q_prim_qp%vf(1)%sf(j, k, 0) 
                ! print *, "NEXT F", F_igr(4, j, k)
                ! print *, "NEXT PRES", q_prim_qp%vf(4)%sf(j, k, 0)
                ! print *, "NEXT JAC", jac_igr(2, j, k + 1), jac_igr(2, j, k) 
                ! print *, "NEXT JAC RHS", jac_rhs_igr(2, j, k+1) , jac_rhs_igr(2, j, k)
                ! print *, "NEXT RHS", rhs_igr(4, j, k), rhs_igr(4, j, k-1), rhs_igr(4, j, k+1) 
                ! print *, "PREV DVDY", dvy_igr(j, k), dvy_igr(4, j, k-1) , dvy_igr(4, j, k+1)              
