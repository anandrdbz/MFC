...
contains
    ...
    impure subroutine s_read_input_file
        ...
        Ca, Web, Re_inv, acoustic_source, acoustic, num_source, polytropic, thermal, integral, integral_wrt, num_integrals, &
            ...
            & int_comp, ic_eps, ic_beta, nv_uvm_out_of_core, nv_uvm_igr_temps_on_gpu, nv_uvm_pref_gpu, down_sample, fft_wrt, bub_0d, pseudo_poly
    ...
    subroutine s_initialize_gpu_vars
        ...
        $:GPU_UPDATE(device='[bub_0d, pseudo_poly]')
