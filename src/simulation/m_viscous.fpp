...
contains
    ...
    subroutine s_compute_viscous_stress_cylindrical_boundary(q_prim_vf, grad_x_vf, grad_y_vf, grad_z_vf, tau_Re_vf, ix, iy, iz)
        ...
        type(scalar_field), dimension(1:), intent(in) :: grad_x_vf, grad_y_vf, grad_z_vf
    ...
    subroutine s_get_viscous(qL_prim_rsx_vf, dqL_prim_dx_n, dqL_prim_dy_n, dqL_prim_dz_n, &
        ...
        type(vector_field), dimension(1:), intent(inout) :: qL_prim, qR_prim
        type(vector_field), intent(in) :: q_prim_qp
        type(vector_field), dimension(1:), intent(inout) :: dqL_prim_dx_n, dqR_prim_dx_n, dqL_prim_dy_n, dqR_prim_dy_n, &
