...
print(json.dumps({
    ...
    'patch_icpp(1)%vel(1)'         : 1,#f"{V0}*sin(x/{L})*cos(y/{L})*sin(z/{L})",
    'patch_icpp(1)%vel(2)'         : 1,#f"-{V0}*cos(x/{L})*sin(y/{L})*sin(z/{L})",
    'patch_icpp(1)%vel(3)'         : 0,
    'patch_icpp(1)%pres'           : 1,#f"{P0} + ({rho0}*{V0}**2/16)*(cos(2*x/{L}) + cos(2*y/{L}))*(cos(2*z/{L}) + 2)",
